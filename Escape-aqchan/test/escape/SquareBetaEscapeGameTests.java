...
class SquareBetaEscapeGameTests
{
	...
	{
		egb = new EscapeGameBuilder(new File("config/SquareEscapeGame.xml"));
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/SquareLinearSetup.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();
	 ...
	 void squareOmniMovementTests() throws Exception {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/SquareOmniSetup.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/SquareOrthogonalSetup.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();
...
//	 }
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/SquareDistanceUnblock.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();
		 assertTrue(e.move(e.makeCoordinate(4, 2), e.makeCoordinate(2, 4)));
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/DistanceJump.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();
		 // diagonal moves
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/squareconfigs/SquareMisc.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();

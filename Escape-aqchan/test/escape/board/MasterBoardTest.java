...
class MasterBoardTest
{
	...
	{
		BoardBuilder bb = new SquareBoardBuilder(new File("config/board/EmptySquareBoard.xml"));
		board = bb.makeBoard();
		assertNotNull(board);
	...
	{
	    BoardBuilder bb = new OrthoSquareBoardBuilder(
    ...
    {
        BoardBuilder bb = new HexBoardBuilder(

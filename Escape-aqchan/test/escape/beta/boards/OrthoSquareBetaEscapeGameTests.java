...
class OrthoSquareBetaEscapeGameTests
{
	...
	{
		egb = new EscapeGameBuilder(new File("config/betaboardconfigs/OrthoSquareEscapeGame.xml"));
    ...
    { 
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/betaboardconfigs/orthoconfigs/OrthoSquareLinear.xml"));
...
//		 assertFalse(e.move(e.makeCoordinate(1, 5), e.makeCoordinate(3, 4)));	 
	 ...
	 {
		 EscapeGameBuilder gameBuilder = new EscapeGameBuilder(new File("config/betaboardconfigs/orthoconfigs/OrthoSquareOmni.xml"));
		 EscapeGameManager e = gameBuilder.makeGameManager();

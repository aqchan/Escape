 ...
 * @version Apr 14, 2020
 */
public class OrthoSquareBoardBuilder implements BoardBuilder
{
	 ...
	 * @throws Exception 
	 */
	public OrthoSquareBoardBuilder (File fileName) throws Exception
	{
	...
	public Board makeBoard()
	{
		...
		throw new EscapeException("The coordinate id does not align with the board type of OrthoSquare.");
	}
	...
	public void initializeBoard(Board b, LocationInitializer... initializers)
	{
		for (LocationInitializer li : initializers) {
			...
			if (li.locationType != null && li.locationType != CLEAR) {
				((OrthoSquareBoard) b).setLocationType(c, li.locationType);
			}
		}
	}
}
